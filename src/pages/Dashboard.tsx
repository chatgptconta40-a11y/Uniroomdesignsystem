        ...
        {user?.type !== 'student' && (
          <Card className="p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl font-bold text-foreground">Próximos passos</h3>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground mb-3">Funcionalidades em desenvolvimento</p>
              <p className="text-sm text-muted-foreground">
                {user?.type === 'landlord' && 'Ferramentas para senhorios serão adicionadas em breve.'}
                {user?.type === 'admin' && 'Painel de administração em desenvolvimento.'}
              </p>
            </div>
          </Card>
        )}
